...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      maxlength: [80, 'A tour name must have less or equel the 40 characters'],
      minlength: [1, 'A tour name must have more or than 10 characters']
    ...
    ratingsAverage: {
      ...
      max: [10, 'Tour must have below 5.0']
    },
    ratingsQuantity: {
      type: Number,
      default: 0
